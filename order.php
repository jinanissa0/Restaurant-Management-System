    ...
    <section class="food-search">
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <input type="text" name="full-name" placeholder="E.g. Jinan Issa" class="input-responsive" required>
            ...
            ?>
            <script>
                const apiKey = "pk.951ec5027a0a4dd079b41b28de7d2b47";
            ...
            const apiUrl = `https://us1.locationiq.com/v1/reverse?key=${apiKey}&lat=${latitude}&lon=${longitude}&format=json`;
            fetch(apiUrl)
